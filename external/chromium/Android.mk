...
LOCAL_SRC_FILES += \
	...
	net/websockets/websocket_frame_handler.cc \
	net/websockets/websocket_handshake.cc \
	net/websockets/websocket_handshake_draft75.cc \
...
LOCAL_C_INCLUDES := \
    ...
    external/chromium/secSmartcardAuth 
...
LOCAL_SHARED_LIBRARIES := libsslengine libstlport libexpat libcrypto libssl libz libicuuc libicui18n libsqlite libcutils liblog libdl libsecnativefeature \
	libnativehelper
...
include $(CLEAR_VARS)
LOCAL_PREBUILT_LIBS := libsslengine.so
