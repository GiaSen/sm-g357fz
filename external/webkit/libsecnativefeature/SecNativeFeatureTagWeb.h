...
// adjuse web backgroun color
#define CscFeature_Web_AdjustColor "CscFeature_Web_AdjustColor"
...
// Imideo service feature (KOR Requirement)
#define CscFeature_Web_EnableImage2Play "CscFeature_Web_EnableImage2Play"

// TMO request to customize the browser bookmark default folder name in chrome browser.
#define CscFeature_Web_DefBookmarkFolderName "CscFeature_Web_DefBookmarkFolderName"

// Use temp model name : JPN docomo requirement
#define CscFeature_Web_UseTempModelName "CscFeature_Web_UseTempModelName"


// Disable Vendor name on User Agent
#define CscFeature_Web_Bool_DisableUserAgentVendor "CscFeature_Web_Bool_DisableUserAgentVendor"

// Disable user_gesture_required_for_media_playback feature 
#define CscFeature_Web_Bool_Disable_User_Gesture_required "CscFeature_Web_Bool_Disable_User_Gesture_required"

// avoid crash localstorage  //ENABLE_LOCALSTORAGE_LIMIT_PER_ORIGIN  //TMO
#define CscFeatureTagWeb_Enable_LocalStorageLimit  "CscFeature_Web_Enable_LocalStorageLimit"

// Disable security warning popup  (TMO requirement)
#define CscFeatureTagWeb_DisableSecurityWarningPopup  "CscFeature_Web_DisableSecurityWarningPopup"

// Customize error page for customer
#define CscFeatureTagWeb_CustomizeErrorPage "CscFeature_Web_CustomizeErrorPage"

// Allow certificate warning in sub-frame (China requirement)
#define CscFeatureTagWeb_AllowCertificateWarningInSubframe4 "CscFeature_Web_AllowCertificateWarningInSubframe4"

// Set Search Engine (China requirement)
#define CscFeatureTagWeb_SetSearchEngineAs "CscFeature_Web_SetSearchEngineAs"

// Enable DRM McAfee AnshinScan feature ( JPN DCM requirment )
#define CscFeatureTagWeb_Enable_AnshinScan "CscFeature_Web_Enable_AnshinScan"
